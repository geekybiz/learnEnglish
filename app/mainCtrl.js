    ...
    $(document).ready(function() {
      $(window).scroll(function() {
        if ($(this).scrollTop() > 200) {
          $('header2').css('background-color', '#fff');
          $('nav.mobile a').css('color', '#384047');
          $('#slideIn-mobile').css('display', 'block');
          $('#slideIn-mobile').show();
        } else {
          $('nav.mobile a').css('color', '#fff');
          $('#slideIn-mobile').hide();
